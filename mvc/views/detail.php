  ...
  <div class="container">
    <div class="son-main">
      ...
      <div class="son-middle">
        <div class="left">
          <img src="../../../public/img/products/<?php echo $product->getProductID(); ?>1_image1.png" alt="637639340541330187_msi-gaming-gf63-den-1" class="" style="width:300px;" />
        </div>
        ...
        <div class="card-body">
          ...
          <p style="text-align: justify">
            ...
            <p style="text-align: center">
              <b><img alt="<?php echo $product->getModel(); ?> (ảnh 1)" src="../../../public/img/products/<?php echo $product->getProductID(); ?>2_image1.png"/></b>
            </p>
              ...
              $i++;
                if ($i%2==0){
                  ...
                  <p style="text-align: center">
                    ...
                    src="../../../public/img/products/<?php echo $product->getProductID(); ?>2_image1<?php echo $i/2 +1;?>.png"/></b>
                  </p>
