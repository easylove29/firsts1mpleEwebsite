...
CREATE TABLE `computer_products` (
  `computer_product_id` int(11) PRIMARY key NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
-- ON products(model,feature);
    ...
    INSERT into products(product_id,model,price,size,weigh,color,number_of_product,supplier,p_description,feature) VALUES(1,'Acer Nitro Gaming AN515-58-52SP/i5-12500H','public/img/Img_product/Acernitrogamingan515-58-52sp.webp',24990000,'30cm*20cm*1.8cm',1.24,'yellow',10,'Acer','máy tính','tính năng 1');
